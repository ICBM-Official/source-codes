...
async def webhookembed(ctx, *, msg: str = None):
    ...
    if msg:
        if embed_perms(ctx.message):
            ...
            await webhook.send(content=ptext, embed=em, username=ctx.message.author.name, avatar_url=ctx.message.author.avatar.url)
